...
void R_TAU0_Create(void)
{
    ...
    TMPR103 = 1U;
    TMPR003 = 1U;
    /* Channel 0 used as frequency divider */
    TMR00 = _8000_TAU_CLOCK_SELECT_CKM1 | _1000_TAU_CLOCK_MODE_TIMN | _0000_TAU_COMBINATION_SLAVE |
            _0000_TAU_TRIGGER_SOFTWARE | _0000_TAU_TIMN_EDGE_FALLING | _0000_TAU_MODE_INTERVAL_TIMER |
            _0000_TAU_START_INT_UNUSED;
    TDR00 = _0005_TAU_TDR00_VALUE;
    TO0 &= ~_0001_TAU_CH0_OUTPUT_VALUE_1;
    TOE0 |= _0001_TAU_CH0_OUTPUT_ENABLE;
    NFEN1 |= _01_TAU_CH0_NOISE_ON;    /* enable using noise filter of TI00 pin input signal */
    /* Channel 1 is used to measure input pulse low-/high-width */
